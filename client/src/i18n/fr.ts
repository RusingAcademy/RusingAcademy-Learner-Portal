export const fr = {
  ...
  // Sprint 41-50 Features
  mockSLE: {
    title: "Examen ELS simulé",
    subtitle: "Simulez l'Évaluation de langue seconde en conditions réelles",
  ...
  coach: {
    ...
    subtitle: "Suivez les progrès des étudiants et offrez un accompagnement personnalisé",
    students: "Étudiants",
    assignments: "Devoirs",
    reviews: "Évaluations",
  ...
  studyGroups: {
    ...
    subtitle: "Apprenez ensemble avec d'autres fonctionnaires",
    create: "Créer un groupe",
    join: "Rejoindre",
    leave: "Quitter",
    browse: "Parcourir les groupes",
    myGroups: "Mes groupes",
    maxMembers: "Membres maximum",
  },
  dictation: {
    title: "Exercices de dictée",
    subtitle: "Améliorez votre écoute et orthographe en transcrivant des phrases françaises",
    play: "Écouter",
    slow: "Lent",
    hint: "Indice",
    check: "Vérifier et suivant",
    skip: "Passer",
    accuracy: "Précision",
  },
  cultural: {
    title: "Immersion culturelle",
    subtitle: "Approfondissez votre compréhension de la culture francophone canadienne",
    topics: "Sujets",
    resources: "Ressources",
  },
  bookmarks: {
    title: "Signets et favoris",
    subtitle: "Accès rapide à votre contenu sauvegardé",
    remove: "Supprimer",
    saved: "Sauvegardé",
  ...
  search: {
    title: "Recherche",
    subtitle: "Recherchez dans tout votre contenu",
    placeholder: "Rechercher notes, vocabulaire, discussions...",
  ...
  dailyReview: {
    ...
    subtitle: "Répétition espacée — révisez les cartes du jour",
