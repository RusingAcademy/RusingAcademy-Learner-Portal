export const en = {
  ...
  mockSLE: {
    title: "Mock SLE Exam",
    subtitle: "Simulate the Second Language Evaluation under real conditions",
  ...
  coach: {
    ...
    subtitle: "Monitor student progress and provide personalized guidance",
    students: "Students",
  ...
  studyGroups: {
    title: "Study Groups",
    subtitle: "Learn together with fellow public servants",
    create: "Create Group",
    join: "Join",
    leave: "Leave",
  ...
  dictation: {
    ...
    subtitle: "Improve listening and spelling by transcribing French sentences",
    play: "Play",
    slow: "Slow",
    hint: "Hint",
    check: "Check & Next",
  ...
  cultural: {
    ...
    subtitle: "Deepen your understanding of Canadian Francophone culture",
    topics: "Topics",
    resources: "Resources",
  },
  bookmarks: {
    title: "Bookmarks & Favorites",
    subtitle: "Quick access to your saved content",
    remove: "Remove",
    saved: "Saved",
  ...
  search: {
    title: "Search",
    subtitle: "Search across all your content",
  ...
  dailyReview: {
    title: "Daily Review",
    subtitle: "Spaced repetition — review flashcards due today",
